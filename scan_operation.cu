// Sample codes for tutorial 5 (inclusive scan)
#include <stdlib.h>
#include <stdio.h>
#include <vector>
#include <iostream>
...
// the kernel computes, per-block, a block-sized scan of the input 
// it assumes that the block size evenly divides the input size
